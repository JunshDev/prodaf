  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      ...
      <div class="form-group">
        ...
        <p class="confirmation-message text-success">Message sent successfully!</p>
      </div>
      <script>
    $(document).ready(function() {
      $('#contact').submit(function(e) {
        e.preventDefault(); // Prevent the form from submitting normally
        // Here you can add an AJAX call to submit the form data to your server if needed

        // Show confirmation message
        $('.confirmation-message').slideDown();
        // Optional: Hide the message after a few seconds
        setTimeout(function() {
          $('.confirmation-message').slideUp();
