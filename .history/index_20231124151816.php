...
<body>
  ...
  <main id="main">
    ...
    <form id="contact" action="forms\mail.php" method="post" class="php-email-form">
      <h1>Contact Form</h1>
    <div class="row">
      <fieldset>
        <input class="form-group col-md-6" placeholder="Your name" name="name" type="text" tabindex="1" autofocus>
      </fieldset>
      <fieldset>
        <input class="form-group col-md-6 mt-3 mt-md-0" placeholder="Your Email Address" name="email" type="email" tabindex="2">
      </fieldset>
    </div>
      <fieldset>
        <input class="form-group mt-3" placeholder="Type your subject line" type="text" name="subject" tabindex="4">
      </fieldset>
      <fieldset>
        <textarea class="form-group mt-3" name="message" placeholder="Type your Message Details Here..." tabindex="5"></textarea>
      </fieldset>
 
      <fieldset>
        <button type="submit" name="send" id="contact-submit">Envoyez</button>
      </fieldset>
    </form>
          </div>
